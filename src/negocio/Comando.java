            ...
            case "manual-usuario":
                switch(accion){
                    ...
                    result= "\n"
                            ...
                            + "4. LOS ATRIBUTOS QUE NUNCA DEBEN REPETIRSE SON EL ID Y EL CORREO ELECTRONICO\n"
                            + "5. SE PUEDEN UTILIZAR LOS SIGUIENTES SIMBOLOS EN VEZ DEL ESPACIO ENTRE PALABRAS:\n"
                            + "  '.' PUNTO \n"
                            + "  '/' SLASH\n"
                            + "\n \n"
                            + "----------------------------- \n"
