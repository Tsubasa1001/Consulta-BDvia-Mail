            ...
            case "manual-usuario":
                switch(accion){
                    ...
                    result= "\n"
                            ...
                            + "2. LOS ATRIBUTOS EMPIEZAN DESPUES DEL ULTIMO (GUION BAJO) '_' Y SE SEPARAN ENTRE SI POR (COMAS) ','\n"
                            + "3. LOS ATRIBUTOS QUE NUNCA DEBEN REPETIRSE SON EL ID Y EL CORREO ELECTRONICO\n"
                            + "4. EN LOS ATRIBUTOS, AL MOMENTO DE REGISTRAR O MODIFICAR, NO PUEDEN HABER ESPACIOS ENTRE LAS PALABRAS\n"
                            + "5. SE PUEDEN UTILIZAR LOS SIGUIENTES CARACTERES EN VEZ DEL ESPACIO ENTRE PALABRAS:\n"
                            + "  '.' PUNTO \n"
                            + "  '/' SLASH\n"
                            + "\n \n"
                            + "----------------------------- \n"
                            ...
                            + "USUARIO-TRABAJADOR\n"
                            + "-----------------------------\n"
                            //100,WORK00100,1227951,Ireneo.Odón,Bolivia,1,Fisioterapeuta.Senior,No.presente,c/.Alameins,100@gmail.com,61561738,36,M,2020-03-31
                            + "ver:\n"
                            + "< USUARIO-TRABAJADOR_VER_1 >\n \n"
                            + "Listar:\n"
                            + "< USUARIO-TRABAJADOR_LISTAR_ALL >\n \n"
                            + "Registrar:\n"
                            + "Introducir los datos           id ,codigo   ,ci     ,nombre     ,nacionalidad,especialidad,cargo,ocupacion  ,direccion  ,email        ,celular,edad,genero,fecha_creacion\n"
                            + "< USUARIO-TRABAJADOR_REGISTRAR_100,WORK00100,1227951,Ireneo.Odón,Bolivia,1,Fisioterapeuta.Senior,No.presente,c/.Alameins,100@gmail.com,61561738,36,M,2020-03-31 >\n \n"
                            + "Modificar:\n"
                            + "Introducir los datos           id ,codigo   ,ci     ,nombre     ,nacionalidad,especialidad,cargo,ocupacion  ,direccion  ,email        ,celular,edad,genero,fecha_creacion,viejo_id\n"
                            + "<USUARIO-TRABAJADOR_MODIFICAR_400,WORK00100,1227951,Ireneo.Odón,Bolivia,1,Fisioterapeuta.Senior,No.presente,c/.Alameins,400@gmail.com,61561738,36,M,2020-03-31,100>\n \n"
                            + "Eliminar:\n"
                            ...
                            + "<SERVICIO_LISTAR_ALL>\n \n"
                            + "Registrar:\n"
                            + "Introducir datos  id,nombreServicio,precio,idequipamiento,idpromocion\n"
                            + "<SERVICIO_REGISTRAR_8,Servicio.Fisio,70,1,1>\n \n"
                            + "Modificar:\n"
                            + "Introducir datos  id,nombreServicio,precio,idequipamiento,idpromocion\n"
                            + "<SERVICIO_MODIFICAR_8,ServicioEDIT.Fisio,70,1,1>\n \n"
                            + "Eliminar:\n"
                            + "<SERVICIO_ELIMINAR_8> \n"
                            + "----------------------------- \n \n \n \n"
                            + "----------------------------- \n"
                            ...
                            + "Registrar:\n"
                            + "Introducir los datos id,codigo,nombreEquipo,idLocal(siempre 1,solo existe un local) \n"
                            + "<EQUIPAMIENTO_REGISTRAR_3,COD03,EquipoEJ,1>\n \n"
                            + "Modificar:\n"
                            + "Introducir los datos id,codigo,nombreEquipo,idLocal(siempre 1,solo existe un local)\n"
                            + "<EQUIPAMIENTO_MODIFICAR_3,COD03,EquipoEDIT,1>\n \n"
                            + "Eliminar:\n"
                            + "<EQUIPAMIENTO_ELIMINAR_3> \n"
                            + "----------------------------- \n \n \n \n"
                            + "----------------------------- \n"
                            + "CONSULTAS \n"
                            + "-----------------------------\n"
                            ...
                            + "Registrar:\n"
                            + "<PROMOCION_REGISTRAR_4,nombrepromocion,4,200.0>\n \n"
                            + "Modificar:\n"
                            + "<PROMOCION_MODIFICAR_4,nombrepromoeditado,4,100.0>\n \n"
                            + "Eliminar:\n"
                            + "<PROMOCION_ELIMINAR_4>\n"
                            + "----------------------------- \n \n \n \n"
                            + "-----------------------------\n"
                            + "GESTIONAR REPORTE Y ESTADISTICA\n"
                            + "-----------------------------\n"
                            + "LISTAR REPORTE:\n"
                            + "<REPORTE_LISTAR_ALL>\n \n"
                            + "Listar estadistica:\n"
